...
$LNG['email_footer_unsub'] = '<br><br><span>This email was sent automatically, if you don\'t want to receive these type of emails from <strong>%s</strong> in the future, please <a href="%s">Unsubscribe</a>.</span>';
$LNG['email_footer_gen'] = '<br><br><span>Copyright &copy; '.date('Y').' <a href="%s">%s</a>. All rights reserved.';
