...
function PageMain() {
	...
	if(isset($_SESSION['adminUsername']) && isset($_SESSION['is_admin'])) {
		...
		if(isset($_GET['b']) && $_GET['b'] == 'security') { // Security Admin Tab
			...
			$as3_regions = array(
			'us-east-2', 'us-east-1', 'us-west-1', 'us-west-2', 'ca-central-1', 'ap-east-1', 'ap-south-1', 'ap-northeast-2', 'ap-southeast-1', 'ap-southeast-2', 'ap-northeast-1', 'eu-central-1', 'eu-west-1', 'eu-west-2', 'eu-south-1', 'eu-west-3', 'eu-north-1', 'af-south-1', 'me-south-1', 'sa-east-1'
			);
